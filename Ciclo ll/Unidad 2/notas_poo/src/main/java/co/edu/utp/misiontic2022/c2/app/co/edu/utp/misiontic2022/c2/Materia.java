package notas_poo.src.main.java.co.edu.utp.misiontic2022.c2.app.co.edu.utp.misiontic2022.c2;
...
public class Materia {
    ...
    public Materia () {
        /*
         * this.nombreMateria = "nomMateria"; this.numeroCredito = 0; this.nota1 = new
         * Nota(); this.nota2 = new Nota(); this.nota3 = new Nota(); this.nota4 = new
         * Nota(); this.nota5 = new Nota();
         */
    ...
    public Materia(String pNomMateria, Integer pNumeroCredito, Integer pNota1_100, Integer pNota2_100,
            Integer pNota3_100, Integer pNota4_100, Integer pNota5_100) {
    ...
    public void calcularPromedio() {
        ...
        this.promedio100 = ((nota1.getEscala100() + nota2.getEscala100() + nota3.getEscala100() + nota4.getEscala100()
